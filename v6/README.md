...
| [DEVICE_PATCHES.md](DEVICE_PATCHES.md) | Fixes made directly on the 3X: turn off the iBooster toggle, move driver-monitoring off the dead DSP onto the CPU, and the `/data/params` vs `/data/params/d` gotcha. Also the full list to reproduce the driving condition on another 3X. |
